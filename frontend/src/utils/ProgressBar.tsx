...
export default function ProgressBar({url, done, todo, total}: ProgressBarProps) {
    ...
    return (
        <div className="w-full px-4">
          <div className="text-center md:w-[50%] mx-auto">
            <div style={{ width: donePercent + '%' }} className="rounded-l-3xl inline-block bg-green-800">
              {queryStats.data[done]}
            </div>
            <div style={{ width: todoPercent + '%' }} className="rounded-r-3xl inline-block bg-red-800">
