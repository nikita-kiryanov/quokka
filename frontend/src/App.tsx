...
function AuthenticatedApp({ onLogout }: { onLogout: () => void }) {
    ...
    const sectionIds = ['games', 'movies', 'tv', 'books', 'hot-sauces'];
    const sectionsJsx = [ComputerGames, Movies, TV, Books, HotSauces];
    const icons = [
    ...
    const [selected, setSelected] = useState(() => {
        ...
        const sectionIndex = sectionParam ? sectionIds.indexOf(sectionParam) : -1;
        if (sectionIndex !== -1) {
            sessionStorage.setItem('selectedSection', sectionIndex.toString());
        ...
        return selectedSection ? parseInt(selectedSection) : 0;
    });
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-neutral-900/50 backdrop-blur z-30"
            ...
            <div className="rounded-xl border border-blue-500 bg-neutral-700 p-6 text-center max-w-sm w-full mx-4">
              ...
              <div className="flex flex-col items-center gap-2 text-sm text-neutral-300">
                <img src="/logos/tmdb-logo.svg" alt="TMDB" className="h-4 opacity-80" />
