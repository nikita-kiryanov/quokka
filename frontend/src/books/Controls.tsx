...
export default function Controls({ onNewBook, completed, toggleCompleted }: ControlsProps) {
    return (
        <>
          <button className="inline-flex items-center justify-center rounded-md bg-emerald-600 px-3 py-1.5 text-sm font-semibold text-white transition-colors hover:bg-emerald-700" onClick={onNewBook}>
            New Book
          </button>
