...
export default function GameCard(props: GameCardProps) {
    ...
    const onContent = (content: string) => onFilter({ type: 'SET_CONTENT', value: content });
    const onDeveloper = (dev: string) => onFilter({ type: 'SET_DEVELOPER', value: dev });
            ...
            <div className="min-w-0 flex-1">
              ...
              <dl className="grid grid-cols-[92px_1fr] gap-x-2 gap-y-2 text-sm">
                ...
                <dd className="text-neutral-100">
                  <ClickableDate date={game.initial_release_date} onClick={onYear} />
                </dd>
                <dt className="text-neutral-400">Genres</dt>
                <dd className="text-neutral-100">
                  <ListOfLinks items={game.game_genres} onClick={onGenre} />
                </dd>
                <dt className="text-neutral-400">Content</dt>
                <dd className="text-neutral-100">
                  <ListOfLinks items={game.content} onClick={onContent} />
                </dd>
                <dt className="text-neutral-400">Developers</dt>
                <dd className="text-neutral-100">
                  <ListOfLinks items={game.developers} onClick={onDeveloper} />
                </dd>
              </dl>
            </div>
          </div>
